...
/* static */ Maybe<void> BernoulliScalarOp::InferLogicalTensorDesc(user_op::InferContext* ctx) {
...
/*static*/ Maybe<void> BernoulliScalarOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) {
...
/* static */ Maybe<void> BernoulliScalarOp::GetSbp(user_op::SbpContext* ctx) {
  ctx->NewBuilder().Broadcast(ctx->inputs()).Broadcast(ctx->outputs()).Build();
  return Maybe<void>::Ok();
}

/* static */ Maybe<void> BernoulliScalarOp::InferNdSbp(user_op::InferNdSbpFnContext* ctx) {
  SbpParallel default_sbp;
  default_sbp.mutable_broadcast_parallel();
  return user_op::InferNdSbp4SrcOp(ctx, default_sbp);
}

/* static */ Maybe<void> BernoulliScalarOp::InferDataType(user_op::InferContext* ctx) {
